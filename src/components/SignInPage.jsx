      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
            Assurit Training Center
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Professional certification training and development
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Access your training courses and track your progress
            </p>
          </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Expert Courses</h3>
            <p className="text-xs text-gray-600 dark:text-gray-400">Professional training materials</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">Monitor your learning journey</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">Industry-recognized credentials</p>
          </div>
        </div>
      </div>
    </div>
